              ...
              <div key={item.id} className="group">
                ...
                <div className="relative w-full aspect-[3/4] overflow-hidden bg-white">
                  <button className="absolute right-1 z-10 p-1 rounded-full hover:scale-110 transition">
                    <Heart size={24} className="text-gray-700 cursor-pointer" />
                  </button>
                ...
                <div className="pt-4">
                  ...
                  className="mt-4 text-md border border-[#C1A58B] rounded-md px-5 py-2 cursor-pointer hover:bg-[#685C20] hover:text-white transition">
                    ADD TO CART
                  </button>
